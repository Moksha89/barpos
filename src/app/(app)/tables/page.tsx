      ...
      <div className="mx-auto grid max-w-7xl gap-5">
        <header className="flex flex-col gap-3 sm:flex-row sm:items-end sm:justify-between">
          <div>
            ...
            <h1 className="mt-1 text-2xl font-black">Active tables</h1>
              ...
              <article key={table.id} className="rounded-2xl bg-white p-4 shadow-sm">
                <div className="flex items-start justify-between gap-3">
                  <div>
                    ...
                    <h2 className="text-xl font-black">{table.tableName}</h2>
                  </div>
        ...
        <section>
          <h2 className="text-xl font-black">Pending bills by waitress</h2>
          <p className="mt-1 text-sm text-stone-600">
            Use this when customers leave without paying and return later.
          </p>
          <div className="mt-3 grid gap-3 md:grid-cols-2 xl:grid-cols-3">
            {visiblePendingOrders.length === 0 ? (
              <article className="rounded-2xl border border-dashed border-stone-300 bg-white p-4 text-sm text-stone-600">
