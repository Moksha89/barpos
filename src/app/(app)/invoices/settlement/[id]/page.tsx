    ...
    <main className="min-h-screen bg-white p-4 text-stone-950">
      <section className="mx-auto max-w-lg border border-stone-200 p-6 print:border-0">
        ...
        <div className="mt-5 grid grid-cols-2 gap-2 text-sm">
          ...
          <p><b>Date:</b> {settlement.createdAt.toLocaleDateString("en-AE")}</p>
          <p><b>From:</b> {settlement.startDate.toLocaleDateString("en-AE")}</p>
          <p><b>To:</b> {settlement.endDate.toLocaleDateString("en-AE")}</p>
        </div>
