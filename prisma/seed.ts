...
async function main() {
  ...
  const items = [
    ...
    // Wine
    { name: "Shiraz Cabernet Bottle", sku: "MENU-SHIRAZ-CABERNET-BOTTLE", purchaseCost: 0, sellingPrice: 150, unitType: "bottle" },
    { name: "Red Wine Glass", sku: "MENU-RED-WINE-GLASS", purchaseCost: 0, sellingPrice: 30, unitType: "glass" },
    { name: "Chardonnay Bottle", sku: "MENU-CHARDONNAY-BOTTLE", purchaseCost: 0, sellingPrice: 150, unitType: "bottle" },
    { name: "White Wine Glass", sku: "MENU-WHITE-WINE-GLASS", purchaseCost: 50, sellingPrice: 30, unitType: "glass" },
    ...
    // Bottle beers
    { name: "Budweiser Bottle", sku: "MENU-BUDWEISER-BOTTLE", purchaseCost: 110, sellingPrice: 25, unitType: "bottle" },
    { name: "Heineken Bottle", sku: "MENU-HEINEKEN-BOTTLE", purchaseCost: 110, sellingPrice: 25, unitType: "bottle" },
    { name: "Corona Bottle", sku: "MENU-CORONA-BOTTLE", purchaseCost: 140, sellingPrice: 32, unitType: "bottle" },
    { name: "King Fisher Bottle", sku: "MENU-KING-FISHER-BOTTLE", purchaseCost: 95, sellingPrice: 45, unitType: "bottle" },

    // Brandy / cognac — 30ml / half / full
    { name: "St-Rémy 30ml", sku: "MENU-ST-REMY-30ML", purchaseCost: 39, sellingPrice: 30, unitType: "peg" },
    { name: "St-Rémy Half", sku: "MENU-ST-REMY-HALF", purchaseCost: 39, sellingPrice: 175, unitType: "half" },
    { name: "St-Rémy Full", sku: "MENU-ST-REMY-FULL", purchaseCost: 39, sellingPrice: 350, unitType: "full" },
    { name: "Hennessy VS 30ml", sku: "MENU-HENNESSY-VS-30ML", purchaseCost: 179, sellingPrice: 40, unitType: "peg" },
    { name: "Hennessy VS Half", sku: "MENU-HENNESSY-VS-HALF", purchaseCost: 179, sellingPrice: 300, unitType: "half" },
    ...
    { name: "Absolut 30ml", sku: "MENU-ABSOLUT-30ML", purchaseCost: 39, sellingPrice: 28, unitType: "peg" },
    { name: "Absolut Half", sku: "MENU-ABSOLUT-HALF", purchaseCost: 0, sellingPrice: 250, unitType: "half" },
    ...
    // Rum — 30ml / half / full
    { name: "Bacardi White 30ml", sku: "MENU-BACARDI-WHITE-30ML", purchaseCost: 50, sellingPrice: 30, unitType: "peg" },
    { name: "Bacardi White Half", sku: "MENU-BACARDI-WHITE-HALF", purchaseCost: 50, sellingPrice: 250, unitType: "half" },
    { name: "Bacardi White Full", sku: "MENU-BACARDI-WHITE-FULL", purchaseCost: 50, sellingPrice: 400, unitType: "full" },
    { name: "Captain Morgan Dark 30ml", sku: "MENU-CAPTAIN-MORGAN-DARK-30ML", purchaseCost: 85, sellingPrice: 30, unitType: "peg" },
    { name: "Captain Morgan Dark Half", sku: "MENU-CAPTAIN-MORGAN-DARK-HALF", purchaseCost: 85, sellingPrice: 250, unitType: "half" },
    ...
    { name: "Captain Morgan Spiced Gold 30ml", sku: "MENU-CAPTAIN-MORGAN-SPICED-GOLD-30ML", purchaseCost: 60, sellingPrice: 30, unitType: "peg" },
    { name: "Captain Morgan Spiced Gold Half", sku: "MENU-CAPTAIN-MORGAN-SPICED-GOLD-HALF", purchaseCost: 60, sellingPrice: 250, unitType: "half" },
    ...
    // Gin — 30ml / half / full
    { name: "Gordon's 30ml", sku: "MENU-GORDONS-30ML", purchaseCost: 50, sellingPrice: 40, unitType: "peg" },
    { name: "Gordon's Half", sku: "MENU-GORDONS-HALF", purchaseCost: 50, sellingPrice: 350, unitType: "half" },
    { name: "Gordon's Full", sku: "MENU-GORDONS-FULL", purchaseCost: 50, sellingPrice: 700, unitType: "full" },
    { name: "Bombay Sapphire 30ml", sku: "MENU-BOMBAY-SAPPHIRE-30ML", purchaseCost: 55, sellingPrice: 28, unitType: "peg" },
    { name: "Bombay Sapphire Half", sku: "MENU-BOMBAY-SAPPHIRE-HALF", purchaseCost: 55, sellingPrice: 200, unitType: "half" },
    ...
    { name: "Jose Cuervo Silver 30ml", sku: "MENU-JOSE-CUERVO-SILVER-30ML", purchaseCost: 45, sellingPrice: 30, unitType: "peg" },
    { name: "Jose Cuervo Silver Half", sku: "MENU-JOSE-CUERVO-SILVER-HALF", purchaseCost: 45, sellingPrice: 250, unitType: "half" },
    ...
    { name: "Ballantine's 30ml", sku: "MENU-BALLANTINES-30ML", purchaseCost: 50, sellingPrice: 28, unitType: "peg" },
    { name: "Ballantine's Half", sku: "MENU-BALLANTINES-HALF", purchaseCost: 50, sellingPrice: 225, unitType: "half" },
    { name: "Ballantine's Full", sku: "MENU-BALLANTINES-FULL", purchaseCost: 50, sellingPrice: 425, unitType: "full" },
    { name: "Red Label 30ml", sku: "MENU-RED-LABEL-30ML", purchaseCost: 45, sellingPrice: 28, unitType: "peg" },
    ...
    { name: "Chivas Regal 12 30ml", sku: "MENU-CHIVAS-REGAL-12-30ML", purchaseCost: 80, sellingPrice: 35, unitType: "peg" },
    ...
    { name: "Jack Daniel's 30ml", sku: "MENU-JACK-DANIELS-30ML", purchaseCost: 65, sellingPrice: 35, unitType: "peg" },
    ...
    { name: "Black Label 30ml", sku: "MENU-BLACK-LABEL-30ML", purchaseCost: 85, sellingPrice: 35, unitType: "peg" },
    ...
    { name: "Double Black 30ml", sku: "MENU-DOUBLE-BLACK-30ML", purchaseCost: 130, sellingPrice: 40, unitType: "peg" },
    { name: "Double Black Half", sku: "MENU-DOUBLE-BLACK-HALF", purchaseCost: 130, sellingPrice: 400, unitType: "half" },
    ...
    { name: "Chivas Regal 18 Years 30ml", sku: "MENU-CHIVAS-REGAL-18-YEARS-30ML", purchaseCost: 200, sellingPrice: 50, unitType: "peg" },
    { name: "Chivas Regal 18 Years Half", sku: "MENU-CHIVAS-REGAL-18-YEARS-HALF", purchaseCost: 200, sellingPrice: 1000, unitType: "half" },
    ...
    { name: "Glenfiddich 12 Years 30ml", sku: "MENU-GLENFIDDICH-12-YEARS-30ML", purchaseCost: 120, sellingPrice: 40, unitType: "peg" },
    { name: "Glenfiddich 12 Years Half", sku: "MENU-GLENFIDDICH-12-YEARS-HALF", purchaseCost: 120, sellingPrice: 350, unitType: "half" },
    { name: "Glenfiddich 12 Years Full", sku: "MENU-GLENFIDDICH-12-YEARS-FULL", purchaseCost: 120, sellingPrice: 700, unitType: "full" },

    // Liqueurs — per peg
    { name: "Baileys Peg", sku: "MENU-BAILEYS-PEG", purchaseCost: 78, sellingPrice: 30, unitType: "peg" },
    { name: "Cointreau Peg", sku: "MENU-COINTREAU-PEG", purchaseCost: 0, sellingPrice: 30, unitType: "peg" },
    { name: "Kahlua Peg", sku: "MENU-KAHLUA-PEG", purchaseCost: 80, sellingPrice: 30, unitType: "peg" },
    ...
    { name: "Jagermeister Peg", sku: "MENU-JAGERMEISTER-PEG", purchaseCost: 55, sellingPrice: 30, unitType: "peg" },
